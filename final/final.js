document.addEventListener("DOMContentLoaded", function () {
    ...
    form.addEventListener("submit", function (event) {
        ...
        console.log("Form submitted:", {
            fullname,
            email,
            favoriteAnime: document.getElementById("favoriteAnime").value.trim(),
            favoriteGenre: document.getElementById("favoriteGenre").value,
            yearsWatching,
            comments: document.getElementById("comments").value.trim()
        });
        form.classList.add("hidden");
        statusMessage.textContent = "Thank you! Your feedback has been received. 😊";
        statusMessage.classList.remove("hidden");
        statusMessage.style.color = "#f5c623";
    });
});